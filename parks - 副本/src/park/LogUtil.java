...
public class LogUtil {
	...
	public static final String LOG_FOLDER = "C://Users/Administrator/Desktop/park";
//	public static final String LOG_FOLDER = "C://Users/dy20190826/park";
		...
		try {            
			...
			fileHandler.setFormatter(new Formatter() {                
				...
				public String format(LogRecord record) { 
					// 设置文件输出格式                    
					return "[ " + getCurrentDateStr(DATE_PATTERN_FULL) + " - Level:"+ record.getLevel().getName().substring(0, 1) + " ]-" + "[" + record.getSourceClassName()+ " -> " + record.getSourceMethodName() + "()] " + record.getMessage() + "\r\n";                
				}            
			});         
